use crate::{
    dto::{CreateWeatherEventDto, GardenIdDto, IdDto, UpdateWeatherEventDto, WeatherEventResponseDto},
...
pub async fn dispatch_weather_event_command(
    ...
    match request.command {
        ...
        CommandType::List => {
            ...
            let result = if let Ok(dto) = serde_json::from_value::<GardenIdDto>(request.payload.clone()) {
